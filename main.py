...
filename = "final.mp3" # INSERT YOUR AUDIO FILE HERE
...
pygame.display.set_caption('Julian, king of manhattan (by renforshort, covered by Shresht :D)')
...
circle_color = (235, 77, 85)
polygon_default_color = [51, 51, 102]
